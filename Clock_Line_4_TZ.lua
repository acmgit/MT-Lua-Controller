...
mem.digit[2] = {a = true, b = false, c = false}
mem.digit[3] = {a = true, b = false, c = false}
mem.digit[4] = {a = true, b = false, c = true}
mem.digit[5] = {a = false, b = false, c = true}
mem.digit[6] = {a = false, b = false, c = true}
mem.digit[7] = {a = true, b = false, c = false}
mem.digit[8] = {a = true, b = false, c = true}
mem.digit[9] = {a = true, b = false, c = true}
...
mem.digit["P"] = {a = true, b = false, c = true}
mem.digit["Q"] = {a = true, b =false, c = true}
mem.digit["R"] = {a = true, b = false, c = true}
mem.digit["S"] = {a = false, b = false, c = true}
...
mem.digit["Z"] = {a = true, b = false, c = false}
